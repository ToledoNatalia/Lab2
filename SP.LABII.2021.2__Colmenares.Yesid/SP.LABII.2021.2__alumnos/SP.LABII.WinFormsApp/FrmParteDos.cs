...
namespace SP.LABII.WinFormsApp
{
    ...
    public partial class FrmParteDos : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            FrmProducto frm = new FrmProducto(new EntidadesSP.Producto("Cepita", "Nectar", 457, 80));
            ...
            if (frm.ShowDialog() == DialogResult.OK)
            {
                ...
                ado.MarcaExistente += new EntidadesSP.MarcaExistente(this.Manejador_marcaExistente);
        ...
        private void Manejador_marcaExistente(object sender, EventArgs e)
        {
            ...
            ///
            List<EntidadesSP.Producto> lista = EntidadesSP.ADO.ObtenerTodos();///reemplazar por lo que corresponda
